...
public class AssignItemCommand_Tests {
    ...
    public void before() {
        ...
        testCommand = new AssignItemCommand(wimRepository);
    }
    ...
    @Test
    public void execute_should_AssignItem_when_ValidInput() {
        //Arrange
        List<String> testList = new ArrayList<>();
        testList.add(testMember.getName());
        testList.add(testTeam.getName());
    ...
    @Test(expected = IllegalArgumentException.class)
    public void execute_should_trow_when_ItemAlreadyAssigned() {
        //Arrange
        List<String> testList = new ArrayList<>();
        testList.add(testMember.getName());
        testList.add(testTeam.getName());
        testList.add(testBoard.getName());
        testList.add(testBug.getTitle());
        wimRepository.getTeams().get(testTeam.getName()).getBoards().get(testBoard.getName()).getBugs()
                .get(testBug.getTitle()).assignMember(testMember);
        //Act & Assert
        testCommand.execute(testList);
//        testCommand.execute(testList);
    }
