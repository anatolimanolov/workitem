...
import com.company.commands.listing.ListBoardsCommand;
...
public class ListBoardCommand_Tests {
    ...
    public static void before(){
        ...
        testCommand = new ListBoardsCommand(wimRepository);
    }
    ...
    @Test(expected = IllegalArgumentException.class)
    public void execute_should_throw_when_NoBoardsAreAdded(){
        //Arrange
        List<String> testList = new ArrayList<>();
        testList.add(testTeam.getName());
